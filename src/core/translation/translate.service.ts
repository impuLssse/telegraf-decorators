...
// import { BotLogger, Logger } from "../../bot-logger";
...
//   async runTranslator(loader: I18nLoader): Promise<Observable<I18nTranslation>> {
//     /** Я сам еще не разобрался че-такое BehaviorSubject */
